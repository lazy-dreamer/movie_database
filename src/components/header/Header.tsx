...
export function Header() {
  ...
  const { isAuth, userName, userId } = useSelector(
        ...
        <NavLink to="/">
          <div className={styles.logo}>
            ...
            <p>
              ...
              <span className="green">M</span>ovie <br />{" "}
              <span className="green">D</span>ata
              <span className="green">B</span>ase
            </p>
          </div>
        </NavLink>
        <div className={styles.header_right}>
          <div
            className={`${styles.mobile_menu} ${showMobileMenu ? "mobile_menu_open" : ""}`}
          >
            <nav className={styles.header_navigation}>
              ...
              {isAuth ? (
                ...
                >
                  Favorites{" "}
                  <span className={styles.fav_count}>{favFilms.length}</span>
                </NavLink>
              ) : (
                ""
              )}
          ...
          <div className={styles.user}>
            ...
            <button
              className={`${styles.menu_btn} ${showMobileMenu ? "opened" : ""}`}
